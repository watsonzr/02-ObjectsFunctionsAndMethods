...
#              The top left corner of the screen is point (0,0)
#
#        -- In what direction on the screen does the positive X-axis point?
#              The positive x-axis points in the right direction.
#
...
#                get_bounding_box, move_center_to, attach_to
#
...
#                RENDER makes the objects that were drawn actually appear on the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#                The close_on_mouse_click call is always necessary, otherwise the window opens in the background
#                   and closes as soon as all the code has run, without allowing you to view it.
#
